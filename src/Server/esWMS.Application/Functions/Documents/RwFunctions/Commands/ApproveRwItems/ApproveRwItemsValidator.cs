using esWMS.Application.Functions.Documents.RwFunctions.Queries.GetRwById;
using FluentValidation;
using MediatR;

namespace esWMS.Application.Functions.Documents.RwFunctions.Commands.ApproveRwItems
{
    internal class ApproveRwItemsValidator : AbstractValidator<ApproveRwItemsCommand>
    {
        private readonly IMediator _mediator;
        public ApproveRwItemsValidator(IMediator mediator)
        {
            _mediator = mediator;
            ...
            RuleFor(x => x)
                ...
                {
                    var documentResponse = await _mediator.Send(new GetRwByIdQuery(value.DocumentId));
