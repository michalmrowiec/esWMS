...
{
    internal class DeleteRwItemCommandHandler(
        IRwRepository wzRepository,
        IDocumentItemRepository documentItemRepository,
        IWarehouseUnitItemRepository warehouseUnitItemRepository,
        ITransactionManager transactionManager)
        : IRequestHandler<DeleteRwItemCommand, BaseResponse>
    {
        private readonly IRwRepository _wzRepository = wzRepository;
        ...
        public async Task<BaseResponse> Handle(DeleteRwItemCommand request, CancellationToken cancellationToken)
        {
