...
namespace esWMS.Application.Functions.Products.Commands
{
    internal class CommonProductValidator<T> : AbstractValidator<T>
        where T : CommonProductCommand
    {
        public CommonProductValidator()
        {
