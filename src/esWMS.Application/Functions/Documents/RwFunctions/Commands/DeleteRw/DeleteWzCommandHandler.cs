...
{
    internal class DeleteRwCommandHandler(
        IRwRepository repository,
        IWarehouseUnitItemRepository warehouseUnitItemRepository,
        ITransactionManager transactionManager)
        : IRequestHandler<DeleteRwCommand, BaseResponse>
    {
        private readonly IRwRepository _repository = repository;
        private readonly IWarehouseUnitItemRepository _warehouseUnitItemRepository = warehouseUnitItemRepository;
        private readonly ITransactionManager _transactionManager = transactionManager;

        public async Task<BaseResponse> Handle(DeleteRwCommand request, CancellationToken cancellationToken)
        {
            RW document;
