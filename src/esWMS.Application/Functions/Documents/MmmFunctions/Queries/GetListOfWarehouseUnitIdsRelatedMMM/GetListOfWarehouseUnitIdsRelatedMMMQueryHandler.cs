...
{
    internal class GetListOfWarehouseUnitIdsRelatedMMMQueryHandler
        (IBaseDocumentRepository<MMM> repository,
        IMapper mapper)
        : IRequestHandler<GetListOfWarehouseUnitIdsRelatedMMMQuery, BaseResponse<string[]>>
    {
        private readonly IBaseDocumentRepository<MMM> _repository = repository;
        private readonly IMapper _mapper = mapper;

        public async Task<BaseResponse<string[]>> Handle
            (GetListOfWarehouseUnitIdsRelatedMMMQuery request, CancellationToken cancellationToken)
        {
